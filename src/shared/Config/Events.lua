...
--   Timestamp : number   — segundos transcurridos desde RoundStarted,
--                          calculado por RoundManager (fuente única del
--                          timer). Nunca os.clock(): es tiempo de CPU del
--                          VM, no apto para timestamps de gameplay. (§4.4)
-- }
...
local STORY_EVENT_TYPES = {
    -- Gameplay core
    ObjectDelivered = "ObjectDelivered", -- data: { instanceId, objectId, playerId }
